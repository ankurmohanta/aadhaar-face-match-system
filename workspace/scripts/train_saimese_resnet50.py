...
def main():
    ...
    pos_dataset = SiamesePairsDataset(pos_path, label=1, transform=transform)
    neg_dataset = SiamesePairsDataset(neg_path, label=0, transform=transform)
    ...
    torch.save(model.state_dict(), "siamese_resnet50_model.pth")
    print("Model saved as siamese_resnet50_model.pth")
